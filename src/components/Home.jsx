    ...
    <div className="container">
      <div className="row" style={{ width: "100%", marginTop: "4rem" }}>
        <div className="col-12 col-lg-6  pt-20">
          ...
          <p style={smallText}>
            Your Premier B2B Pharmaceutical supply chain partner in Nigeria. We
            streamline the process for pharmacy stores to place bulk orders
          ...
          <div className="mt-3 flex">
            <p className="mr-4">Licensed by PCN</p>
